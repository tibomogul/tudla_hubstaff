...
export default class extends Controller {
  ...
  open(event) {
    ...
    console.log("Opening modal for activity:", this.currentActivityId, "hubstaff task:", this.currentHubstaffTaskId, "with map URL:", this._mapUrl)
  ...
  selectItem(event) {
    ...
    console.log("selectItem called - tudla_task_id:", tudlaTaskId, "mapUrl:", mapUrl)
